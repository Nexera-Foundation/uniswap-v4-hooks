...
import {ZeroILSwapSamePoolHook} from "./ZeroILSwapSamePoolHook.sol";
...
contract UniswapV4HookFactory is Ownable {
    ...
    function verifyHookAddressPermissions(IHooks hookAddress, Hooks.Permissions calldata permissions) public pure returns (bool) {
        return
            ...
            permissions.afterRemoveLiquidityReturnDelta == hookAddress.hasPermission(Hooks.AFTER_REMOVE_LIQUIDITY_RETURNS_DELTA_FLAG);
    }
